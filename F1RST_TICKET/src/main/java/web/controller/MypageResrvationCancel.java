...
@WebServlet("/mypage/resCancel")
public class MypageResrvationCancel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Paging paging = reservationSerivce.getDeletePaging(req);
//		System.out.println(paging);
		...
		List<Reservation> deleteList = reservationSerivce.getList(paging,user);
