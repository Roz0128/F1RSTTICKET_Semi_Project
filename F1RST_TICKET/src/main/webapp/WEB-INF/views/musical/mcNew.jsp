...
<!-- 조회결과 반환 -->
<% List<Musical> mcNewList = (List) request.getAttribute("mcNewList"); %>
...
$(document).ready(function(){
	...
	$(".dropdown").on("hide.bs.dropdown", function(){
		$("#dropdownMenu1").html('신규보기 <span class="glyphicon glyphicon-chevron-down"></span>');
	});
	$(".dropdown").on("show.bs.dropdown", function(){
		$("#dropdownMenu1").html('신규보기 <span class="glyphicon glyphicon-chevron-up"></span>');
	});
...
<div class="text-center">
	...
	<div class="dropdown" style="display:inline-block;">
  		<button onclick="handleTitleClick()" class="btn btn-default.focus dropdown-toggle btn-lg" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">
    		신규보기 <span id="icon" class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span>
	  	</button>
...
<c:forEach var="musical" items="${mcNewList}"> 
