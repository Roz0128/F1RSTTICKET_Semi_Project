...
<div class="form-group">
	<label for="searchPwPhone" class="col-sm-4 control-label">휴대 전화</label>
	<div class="col-sm-4">
		<input type="text" name="searchPwPhone" id="searchPwPhone" class="form-control" placeholder='"-"를 제외하고 숫자만 입력하세요.'> <br>
	</div>
</div>
